...
At sea level, we assume and temperature (T<sub>0</sub>) of 10° C and an atmospheric pressure (p<sub>0</sub>) of 101.0 kPa. These quantities are extrapolated to higher elevation with a constant linear temperature
