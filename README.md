...
At sea level, we assume and temperature of (T<sub>0</sub>) = 10° C and an atmospheric pressure of (p<sub>0</sub>) = 101.0 kPa. These quantities are extrapolated to higher elevation with a constant linear temperature
